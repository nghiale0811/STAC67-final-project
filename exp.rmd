...
data_test3 <- n_data_test[, -c(1, 2)] # exclude date, rented bike count
...
nn <- nnet(`Rented.Bike.Count`~.-`Dew.point.temperature..C.`-`Solar.Radiation..MJ.m2.`-`Snowfall..cm.`, data = data_train3, linout = FALSE, size=50, maxit = 2000, rang=0.05, decay=5e-4, trace = TRUE)
